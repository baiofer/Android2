...
class ShopDAO(var dbHelper: DBHelper): DAOPersistable<ShopEntity> {
    ...
    fun contentValues(shopEntity: ShopEntity): ContentValues {
        ...
        content.put(DBConstants.KEY_SHOP_ID_JASON, shopEntity.id)
        ...
        content.put(DBConstants.KEY_SHOP_OPENING_HOURS, shopEntity.description)
    ...
    fun entityFromCursor(cursor: Cursor): ShopEntity? {
        ...
        return ShopEntity(
                cursor.getLong(cursor.getColumnIndex(DBConstants.KEY_SHOP_ID_JASON)),
